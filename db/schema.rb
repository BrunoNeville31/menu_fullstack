...
ActiveRecord::Schema[7.1].define(version: 2024_03_05_200648) do
  ...
  create_table "company_workings", force: :cascade do |t|
    t.integer "day"
    t.string "opened"
    t.string "closed"
    t.bigint "company_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_company_workings_on_company_id"
  end
  ...
  add_foreign_key "company_workings", "companies"
